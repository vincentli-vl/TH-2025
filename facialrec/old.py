...
# You can use your own image by replacing 'path_to_your_image.jpg' with the actual path.
# For this example, let's use a sample image that's likely to show a clear emotion.
# If you don't have one, save an image of a face and put its path here.
